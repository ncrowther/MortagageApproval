...
public class MlApiBeanInfo extends SimpleBeanInfo {
    private Class beanClass = MlApi.class;
    ...
    // public static String startProcessAndWait(String baseUrl, String tenantId, String username, String password, String processName, String payload, Integer waitSeconds) throws MlApiException, InterruptedException {
    ...
    public static void main(String[] args) {
        ...
        MlApiBeanInfo test = new MlApiBeanInfo();
